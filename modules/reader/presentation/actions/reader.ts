...
export async function getHighlightsAction(bookId: string): Promise<ServerActionResult<HighlightDto[]>> {
  try {
    const user = await requireAuth();
    const supabase = await createSupabaseServerClient();
    const repository = new SupabaseHighlightRepository(supabase);
    
    const result = await executeGetHighlights(repository, { userId: user.id, bookId });
...
export async function getBookmarksAction(bookId: string): Promise<ServerActionResult<BookmarkDto[]>> {
  try {
    const user = await requireAuth();
    const supabase = await createSupabaseServerClient();
    const repository = new SupabaseBookmarkRepository(supabase);

    const result = await executeGetBookmarks(repository, { userId: user.id, bookId });
...
export async function getNotesAction(bookId: string): Promise<ServerActionResult<any>> {
  try {
    const user = await requireAuth();
...
export async function createHighlightAction(payload: any): Promise<ServerActionResult<any>> {
  try {
    const user = await requireAuth();
    const supabase = await createSupabaseServerClient();
    const repository = new SupabaseHighlightRepository(supabase);
    
    const data = await executeCreateHighlight(repository, { ...payload, userId: user.id });
    return { success: true, data: data };
  } catch (error: any) {
    return { success: false, error: { message: error.message || "An unexpected error occurred" } };
  }
...
export async function deleteHighlightAction(highlightId: string): Promise<ServerActionResult<any>> {
  try {
    const user = await requireAuth();
...
export async function createNoteAction(payload: any): Promise<ServerActionResult<any>> {
  try {
    const user = await requireAuth();
...
export async function updateNoteAction(payload: any): Promise<ServerActionResult<any>> {
  try {
    const user = await requireAuth();
...
export async function deleteNoteAction(noteId: string): Promise<ServerActionResult<any>> {
  try {
    const user = await requireAuth();
...
export async function createBookmarkAction(payload: any): Promise<ServerActionResult<any>> {
  try {
    const user = await requireAuth();
    const supabase = await createSupabaseServerClient();
    const repository = new SupabaseBookmarkRepository(supabase);
    
    const data = await executeCreateBookmark(repository, { ...payload, userId: user.id });
    return { success: true, data: data };
  } catch (error: any) {
    return { success: false, error: { message: error.message || "An unexpected error occurred" } };
  }
...
export async function deleteBookmarkAction(bookmarkId: string): Promise<ServerActionResult<any>> {
  try {
    const user = await requireAuth();
...
export async function updateReaderPositionAction(payload: any): Promise<ServerActionResult<any>> {
  try {
    const user = await requireAuth();
    const supabase = await createSupabaseServerClient();
    const repository = new SupabaseReaderPositionRepository(supabase);
    
    const data = await executeUpdateReaderPosition(repository, { ...payload, userId: user.id });
    return { success: true, data: data };
  } catch (error: any) {
    return { success: false, error: { message: error.message || "An unexpected error occurred" } };
  }
...
export async function completeReadingSessionAction(payload: any): Promise<ServerActionResult<any>> {
  try {
    const user = await requireAuth();
    const data = await executeCompleteReadingSession({ ...payload, userId: user.id });
    return { success: true, data: data };
  } catch (error: any) {
    return { success: false, error: { message: error.message || "An unexpected error occurred" } };
  }
