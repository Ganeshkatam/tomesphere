...
import { PipelineExecutionContext, RecommendationPipelineObserver } from './RecommendationPipelineStage';
...
class MockProvider implements CandidateProvider {
    async retrieveCandidates(intent: CandidateIntent, limit: number): Promise<RecommendationCandidate[]> {
        return [
            ...
            { bookId: '2', title: 'Book 2', authors: ['Author B'], popularity: 8, categories: [], language: 'fr', searchScore: 1 },
        ];
    }
}
