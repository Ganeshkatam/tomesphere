...
describe('UserProgress Aggregate', () => {
    ...
    it('✓ streak extension', () => {
        ...
        expect(events.some(e => e.constructor.name === 'StreakExtended')).toBe(true);
    });
    ...
    it('✓ achievement unlock', () => {
        ...
        const events = userProgress.domainEvents;
        expect(events.some(e => e.constructor.name === 'AchievementUnlocked')).toBe(true);
    });
    ...
    it('✓ duplicate achievement ignored', () => {
        ...
        userProgress.unlockAchievement('first-book');
        const events = userProgress.domainEvents;
        expect(events.some(e => e.constructor.name === 'AchievementUnlocked')).toBe(false);
    });
    ...
    it('✓ reading goal completion', () => {
        ...
        expect(events.some(e => e.eventName === 'ReadingGoalCompleted')).toBe(false);
        ...
        expect(events.some(e => e.eventName === 'ReadingGoalCompleted')).toBe(true);
    });
    ...
    it('✓ emitted events', () => {
        ...
        const events = userProgress.domainEvents;
        expect(events.some(e => e.eventName === 'ReadingProgressApplied')).toBe(true);
        expect(events.some(e => e.eventName === 'ReadingGoalCompleted')).toBe(true);
    });
