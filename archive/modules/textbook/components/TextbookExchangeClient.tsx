...
interface TextbookExchangeClientProps {
    initialListings: Listing[];
}

export default function TextbookExchangeClient({ initialListings }: TextbookExchangeClientProps) {
    ...
    const filteredListings = useMemo(() => {
        ...
        if (searchTerm) {
            ...
            filtered = filtered.filter(listing =>
                ...
                listing.author?.toLowerCase().includes(lower)
            );
        }

        return filtered;
    }, [initialListings, conditionFilter, searchTerm]);
