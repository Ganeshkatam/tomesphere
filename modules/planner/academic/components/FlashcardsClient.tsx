...
import { createFlashcard, deleteFlashcard, getFlashcards } from '@/modules/planner/academic/actions/academic';
...
export default function FlashcardsClient({ initialFlashcards }: FlashcardsClientProps) {
    ...
    const handleCreate = async () => {
        ...
        try {
            const res = await createFlashcard(newCard.subject || null, newCard.front, newCard.back);
