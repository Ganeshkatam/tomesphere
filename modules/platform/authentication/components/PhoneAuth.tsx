...
export default function PhoneAuth() {
    ...
    const handleSendOTP = async (e: React.FormEvent) => {
        ...
        try {
            const { sendPhoneOTP } = await import('@/modules/platform/authentication/actions/auth');
    ...
    const handleVerifyOTP = async (e: React.FormEvent) => {
        ...
        try {
            const { verifyPhoneOTP } = await import('@/modules/platform/authentication/actions/auth');
