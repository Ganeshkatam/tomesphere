...
│   │   │       ├── LibraryReadRepository.ts
│   │   │       └── LibraryWriteRepository.ts
│   │   └── infrastructure
│   │       └── repositories
│   │           ├── SupabaseCollectionRepository.ts
│   │           ├── SupabaseLibraryReadRepository.ts
...
│   │   │   ├── domain
│   │   │   │   └── repositories
│   │   │   │       └── AnnouncementReadRepository.ts
│   │   │   └── infrastructure
│   │   │       └── repositories
│   │   │           └── SupabaseAnnouncementReadRepository.ts
│   │   ├── authentication
│   │   │   ├── actions
│   │   │   │   └── auth.ts
│   │   │   ├── components
...
│   │       ├── domain
│   │       │   └── repositories
│   │       │       └── SupportReadRepository.ts
│   │       └── infrastructure
│   │           └── repositories
│   │               └── SupabaseSupportReadRepository.ts
│   ├── progress
│   │   ├── analytics
│   │   │   ├── actions
│   │   │   ├── components
...
│       │   │   │   └── ProfileMapper.ts
│       │   │   └── repositories
│       │   │       ├── SupabaseNotificationReadRepository.ts
