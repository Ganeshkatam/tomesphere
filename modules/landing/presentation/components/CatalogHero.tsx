  ...
  return (
    <section className="relative py-20 sm:py-24 lg:py-32 overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full max-w-[2000px] pointer-events-none">
        <div
          className="absolute top-20 left-10 w-[500px] h-[500px] bg-indigo-600/20 rounded-full blur-[100px] mix-blend-screen animate-pulse"
          style={{ animationDuration: "4s" }}
        />
        <div
          className="absolute top-40 right-10 w-[400px] h-[400px] bg-purple-600/20 rounded-full blur-[100px] mix-blend-screen animate-pulse"
      ...
      <div className="w-full max-w-[2000px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <FadeIn className="text-center" delay={0.2}>
          ...
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-display font-bold mb-6 leading-[1.1] tracking-tight">
            <span className="text-balance text-white drop-shadow-sm">
              Find Books That
            </span>
            <br />
          ...
          <p className="text-lg sm:text-xl mb-10 text-balance max-w-2xl mx-auto leading-relaxed text-slate-400">
            {user
              ? "Explore personalized recommendations and discover your next favorite book"
              : "Your personalized reading journey awaits"}
          </p>
            ...
            {selectedGenres.length > 0 && (
              <div className="flex flex-wrap items-center gap-2 mt-4 px-2">
                ...
                {selectedGenres.map((genre) => (
                  <span
                    key={genre}
                    className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium bg-indigo-500/10 text-indigo-400 border border-indigo-500/20"
                  >
                    {genre}
                    <button
                      onClick={() =>
