...
export default function VerificationStatus() {
    ...
    const checkVerification = async () => {
        const { getUserVerificationStatus } = await import('@/modules/platform/authentication/actions/auth');
    ...
    const resendEmail = async () => {
        const { resendVerificationEmail } = await import('@/modules/platform/authentication/actions/auth');
        const res = await resendVerificationEmail();
        
        if (!res.success) {
            showError(res.error || 'Failed to send email');
        } else {
