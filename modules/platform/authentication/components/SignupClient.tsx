...
import { Lock, Mail, User, ArrowRight, BookOpen, ChevronDown, Sparkles, Shield, RefreshCw, Eye, EyeOff } from 'lucide-react';
                    ...
                    <div className="space-y-6 relative z-10">
                        <div className="space-y-3">
                            ...
                            <p className="text-slate-400 text-sm leading-relaxed max-w-sm">
                                Build your personal reading list, annotate books as you read, and create study cards to remember what matters.
                            </p>
                        </div>
                            ...
                            <div className="glass bg-[var(--surface-default)]/60 border border-[var(--border-subtle)] rounded-2xl p-5 w-full max-w-sm sm:w-[350px] space-y-4 shadow-2xl relative overflow-hidden">
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <h4 className="text-slate-50 text-xs font-semibold tracking-wide truncate max-w-[200px]">New Library</h4>
                                    </div>
                                    <span className="text-[10px] text-indigo-400 font-mono animate-pulse">Setup</span>
                                </div>
                        ...
                        <form onSubmit={handleSignup} className="space-y-4">
                            ...
                            <div className="relative group">
                                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none z-10">
                                    <User className="text-slate-500 group-focus-within:text-indigo-400 transition-colors" size={16} />
                                </div>
                                <input
                                    type="text"
                                    value={name}
                            ...
                            <div className="relative my-4">
                                ...
                                <div className="relative flex justify-center text-xs"><span className="px-3 bg-[#0a0f1d] text-slate-500">or</span></div>
                            </div>
