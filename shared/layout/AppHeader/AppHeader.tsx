...
export function AppHeader({ className = "", variant = "application" }: AppHeaderProps) {
  ...
  return (
    ...
    >
      {/* Upper Tier */}
      <div className="h-16 max-w-7xl mx-auto px-1.5 sm:px-3 lg:px-3 flex items-center justify-between gap-4">
        {/* Logo */}
        <Link
          href="/"
      ...
      {variant === "application" && (
        <div className="border-t border-[var(--border-subtle)]">
          <div className="max-w-7xl mx-auto px-1.5 sm:px-3 lg:px-3 h-11 flex items-center">
