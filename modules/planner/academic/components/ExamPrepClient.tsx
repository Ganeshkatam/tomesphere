...
export default function ExamPrepClient({ initialStats }: ExamPrepClientProps) {
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div className="glass-strong rounded-2xl p-6">
                        ...
                        <p className="text-3xl font-bold text-white">{initialStats.totalTests}</p>
                    </div>
                    ...
                    <div className="glass-strong rounded-2xl p-6">
                        ...
                        <p className="text-3xl font-bold text-white">{initialStats.averageScore}%</p>
                    </div>
                    ...
                    <div className="glass-strong rounded-2xl p-6">
                        ...
                        <p className="text-3xl font-bold text-white">{initialStats.totalFlashcards}</p>
                    </div>
                </div>
