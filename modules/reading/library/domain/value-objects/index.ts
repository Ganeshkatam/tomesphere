...
export class ReadingState extends ValueObject<ReadingStateProps> {
  ...
  static wantToRead(): ReadingState {
    return new ReadingState({ value: "want_to_read" });
  }
  static reading(): ReadingState {
    return new ReadingState({ value: "currently_reading" });
  }
  static finished(): ReadingState {
    return new ReadingState({ value: "finished" });
  }
  static abandoned(): ReadingState {
    return new ReadingState({ value: "abandoned" });
  }
  ...
  isActive(): boolean {
    return this.value === "currently_reading";
  }
  allowsProgress(): boolean {
    return this.value === "currently_reading" || this.value === "finished";
  }
