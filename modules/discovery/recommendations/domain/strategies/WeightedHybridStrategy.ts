import { RecommendationStrategy, RankedRecommendation } from './RecommendationStrategy';
...
export class WeightedHybridStrategy implements RecommendationStrategy {
    constructor(private readonly scorers: readonly { scorer: RecommendationScorer; weight: number }[]) {}
