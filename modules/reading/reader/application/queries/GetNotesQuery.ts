...
import { ReaderNote, AnnotationTarget } from '@/modules/shared/core/events/types';
...
export async function executeGetNotes(request: GetNotesRequest): Promise<ReaderNote[]> {
