...
export interface AnalyticsProjectionStore {
    recordPagesRead(userId: string, bookId: string, pagesDelta: number, dateStr: string): Promise<void>;
    recordBookCompleted(userId: string, bookId: string, dateStr: string): Promise<void>;
    recordBookStarted(userId: string, bookId: string, dateStr: string): Promise<void>;
    updateBookRating(userId: string, bookId: string, rating: number): Promise<void>;
...
export class SupabaseAnalyticsProjectionStore implements AnalyticsProjectionStore {
    ...
    async recordPagesRead(userId: string, bookId: string, pagesDelta: number, dateStr: string): Promise<void> {
    ...
    async recordBookCompleted(userId: string, bookId: string, dateStr: string): Promise<void> {
        const monthStr = dateStr.substring(0, 7);
        const genre = await this.getBookGenre(bookId);
    ...
    async recordBookStarted(userId: string, bookId: string, dateStr: string): Promise<void> {
        const genre = await this.getBookGenre(bookId);
    ...
    async updateBookRating(userId: string, bookId: string, rating: number): Promise<void> {
        const genre = await this.getBookGenre(bookId);
