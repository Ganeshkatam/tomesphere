      ...
      <div id="genre-section" className="mt-8">
        ...
        <div className="max-w-3xl mx-auto mb-6 relative">
          <div className="flex gap-2">
            ...
            <button
              ...
              className={`px-6 py-3 rounded-xl font-medium transition-all flex items-center gap-2 whitespace-nowrap h-fit ${
        ...
        <div className="flex justify-center gap-3 mt-4">
          {genresToShow <
            ...
            <button
              onClick={() =>
                setGenresToShow((prev) => Math.min(prev + 5, genres.length))
              }
