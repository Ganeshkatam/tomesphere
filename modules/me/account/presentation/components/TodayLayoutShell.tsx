      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8 p-6 sm:p-8 rounded-3xl bg-[var(--surface-default)] border border-[var(--border-default)] shadow-[var(--shadow-sm)] flex flex-col sm:flex-row items-center justify-between gap-6 animate-in fade-in duration-300">
          <div className="flex flex-col sm:flex-row items-center gap-5 text-center sm:text-left">
            {/* Avatar */}
            <div className="relative w-20 h-20 rounded-2xl bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 border border-[var(--border-strong)] flex items-center justify-center text-white font-extrabold text-2xl shadow-lg shrink-0 overflow-hidden">
