...
export class ReadingGoal extends ValueObject<ReadingGoalProps> {
    get dailyMinutesTarget(): number { return this.props.dailyMinutesTarget; }
    get yearlyBooksTarget(): number { return this.props.yearlyBooksTarget; }
    get dailyMinutesProgress(): number { return this.props.dailyMinutesProgress; }
    get yearlyBooksProgress(): number { return this.props.yearlyBooksProgress; }
    get lastUpdatedDate(): string { return this.props.lastUpdatedDate; }
    ...
    applyProgress(activity: ReadingActivity): { newGoal: ReadingGoal; justCompletedDaily: boolean } {
        ...
        const newGoal = new ReadingGoal({
            ...
            yearlyBooksProgress: this.props.yearlyBooksProgress + activity.completedBooks,
